      ...
      <section className="py-12 px-4 sm:px-8 max-w-7xl mx-auto">
        ...
        {filteredProducts.length > 0 ? (
          ...
          <div className="flex flex-col items-center justify-center py-20 bg-slate-800/50 rounded-3xl border border-slate-700/50">
            <div className="bg-slate-700 p-6 rounded-full mb-4 opacity-50"><FaShoppingCart className="text-4xl text-slate-400" /></div>
            <p className="text-xl text-slate-400 font-medium">No products found for "{query}"</p>
            <p className="text-sm text-slate-500 mt-2">Try checking your spelling or use different keywords.</p>
            <button onClick={() => navigate('/')} className="mt-6 px-6 py-2 bg-blue-600 hover:bg-blue-500 text-white rounded-full text-sm font-bold transition-colors">Browse All Products</button>
          </div>
        )}
      </section>
    </main>
